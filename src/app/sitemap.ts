...
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.jujutsulegacywiki.wiki'

// 内容类型优先级配置（与 navigation.ts CONTENT_TYPES 对齐：codes/guide/techniques/vessels/clans/builds）
