...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Jujutsu Legacy Wiki',
    description: 'Copyright and intellectual property information for Jujutsu Legacy Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Jujutsu Legacy Wiki',
      description: 'Copyright and intellectual property information for Jujutsu Legacy Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Jujutsu Legacy Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Jujutsu Legacy Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Jujutsu Legacy Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Jujutsu Legacy Developers</strong> - Creators of the Jujutsu Legacy game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Jujutsu Legacy</strong> - Trademark of the game developers</li>
              <li><strong>Jujutsu Legacy Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Jujutsu Legacy Wiki.
            </p>
            ...
            <p>
              ...
              Jujutsu Legacy Wiki<br />
              Email: <a href="mailto:dmca@jujutsulegacywiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@jujutsulegacywiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Jujutsu Legacy Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Jujutsu Legacy Wiki (jujutsulegacywiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@jujutsulegacywiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@jujutsulegacywiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@jujutsulegacywiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@jujutsulegacywiki.wiki</a>
            </p>
            <p>
