...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.jujutsulegacywiki.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Jujutsu Legacy Wiki",
    description: "Read the Terms of Service for Jujutsu Legacy Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "Jujutsu Legacy Wiki",
      title: "Terms of Service - Jujutsu Legacy Wiki",
      description: "Terms and conditions for using Jujutsu Legacy Wiki.",
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: "Jujutsu Legacy Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Jujutsu Legacy Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Jujutsu Legacy Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Jujutsu Legacy Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Jujutsu Legacy Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Jujutsu Legacy". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and progression strategies</li>
              <li>Active and expired code lists</li>
              <li>Cursed technique and vessel breakdowns</li>
              <li>Boss, raid, and encounter guides</li>
              <li>PVE, PVP, and tier list content</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Jujutsu Legacy Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation (Roblox) or the official developers of Jujutsu Legacy. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Jujutsu Legacy Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation (Roblox) and/or the developers of Jujutsu Legacy. We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> Roblox and Jujutsu Legacy availability may change without notice. We are not responsible for game access, server outages, or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, JUJUTSU LEGACY WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Jujutsu Legacy Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@jujutsulegacywiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@jujutsulegacywiki.wiki</a>
            </p>
            <p>
